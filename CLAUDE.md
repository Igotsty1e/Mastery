...
- `/Users/ivankhanaev/Mastery/docs/plans/arrival-ritual.md` is the approved screen contract for the onboarding + first-exercise V2 wave. The 3-step onboarding shipped 2026-04-26 (`app/lib/screens/onboarding_arrival_ritual_screen.dart`); the first-exercise V2, motion polish, and QA briefs remain open. Use it together with `DESIGN.md` before changing those flows.
