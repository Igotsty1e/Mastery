...
- ~~D1/D7 retention dashboard — V1 ships the raw event stream; the dashboard query is a V1.5 follow-up.~~ Shipped 2026-04-28: `cohortRetention` SQL aggregation in `backend/src/admin/retention.ts`, JSON + HTML routes at `GET /admin/retention[.html]` gated by `ADMIN_USER_IDS` env var. Wave 14.1.
