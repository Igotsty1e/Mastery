...
| [`plans/automaticity-pivot.md`](plans/automaticity-pivot.md) | **Active live roadmap** for the automaticity pivot. Tracks Waves 0 / A / B / C / D / G1–G9 / H1 / H2 / H3 (phase 1) shipped state and the planned next steps (Wave E diagnostic redesign, Wave F hint stripping, Wave H3 phases 2 + 3, dual-verdict extension to open-form types, latency-driven engine tuning). Update in lockstep with each shipped wave. |
