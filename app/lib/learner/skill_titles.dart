...
/// §2.2`. Embedded for the two shipped B2 skills; new skills must be
/// added here in lockstep with `backend/data/skills.json` until a
/// dedicated `GET /skills` endpoint lands (deferred to a later wave).
///
